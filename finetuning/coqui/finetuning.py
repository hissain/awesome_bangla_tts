...
def evaluate_model(model_path, config_path, test_meta_path):
    ...
    for i, sample in enumerate(test_samples):
        ...
        librosa.output.write_wav(ref_file_path, ref_audio, sr)
        ...
        try:
            ...
            librosa.output.write_wav(original_file_path, original_audio, Config.target_sample_rate)
            ...
            librosa.output.write_wav(finetuned_file_path, finetuned_audio, Config.target_sample_rate)
